...
<div
	class="<?php echo esc_attr($hide_labels); ?> animated fadeIn listing-list-loop stm-listing-directory-list-loop stm-isotope-listing-item all <?php print_r(implode(' ', $classes)); ?>"

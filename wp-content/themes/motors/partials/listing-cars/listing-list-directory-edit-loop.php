...
<div
	class="<?php echo esc_attr($hide_labels); ?> listing-list-loop listing-list-loop-edit <?php echo esc_attr(get_post_status(get_the_id())); ?> stm-listing-directory-list-loop stm-isotope-listing-item all <?php print_r(implode(' ', $classes)); ?>"

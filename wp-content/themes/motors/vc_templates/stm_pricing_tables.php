								...
								<div class="stm-pricing-table heading-font">
											...
											<div class="stm-pricing-table__periods-link" data-period="<?php echo esc_attr( ${'pt_' . $i . '_periods_item'}['pt_'. $i .'_periods_period'] ); ?>">
												<?php if( !empty( ${'pt_' . $i . '_periods_item'}['pt_'. $i .'_periods_link'] ) ) : ?>
													<div class="stm-pricing-table__action">
														<a href="<?php echo esc_url( WC()->cart->get_checkout_url() . '?add-to-cart=' .  ${'pt_' . $i . '_periods_item'}['pt_'. $i .'_periods_link']); ?>" class="button"><?php echo esc_html( ${'pt_' . $i . '_link_text'} ); ?><i class="stm-icon stm-icon-arrow-right"></i></a>
													</div>
												<?php endif; ?>
											</div>
										<?php endforeach; ?>
									<?php else: ?>
										<?php if( isset( ${'pt_' . $i . '_add_to_cart'} ) && !empty(${'pt_' . $i . '_add_to_cart'}) && !empty( ${'pt_' . $i . '_link_text'} ) ) : ?>
											<div class="stm-pricing-table__action">
												<a href="<?php echo esc_url( WC()->cart->get_checkout_url() . '?add-to-cart=' . ${'pt_' . $i . '_add_to_cart'}); ?>" class="button"><?php echo esc_html( ${'pt_' . $i . '_link_text'} ); ?><i class="stm-icon stm-icon-arrow-right"></i></a>
											</div>
